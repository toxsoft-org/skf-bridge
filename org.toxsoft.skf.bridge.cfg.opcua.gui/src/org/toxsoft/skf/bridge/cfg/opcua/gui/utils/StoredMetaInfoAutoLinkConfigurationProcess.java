...
public class StoredMetaInfoAutoLinkConfigurationProcess
  ...
  public IList<OpcToS5DataCfgUnit> formCfgUnitsFromAutoElements( ITsGuiContext aContext, ISkConnection currConn,
    ...
    for( CmdGwid2UaNodes cmd2Nodes : autoElements ) {
      ...
      String strid =
          String.format( CFG_CMD_UNIT_ID_FORMAT, Long.valueOf( System.currentTimeMillis() ), cmd2Nodes.gwid().strid() );
      ...
      OpcUaUtils.OP_CMD_JAVA_CLASS.setValue( realization, avStr( COMMANDS_JAVA_CLASS_VALUE_COMMAND_BY_ONE_TAG_EXEC ) );
      if( cmdArgParam != null ) {
      ...
      OpcToS5DataCfgUnit unit = new OpcToS5DataCfgUnit( strid, name, gwids, conertToAtomicList( nodes ) );
    ...
    for( UaNode2Gwid rriAttrNode : nodes2Gwids ) {
      ...
      BitIdx2RriDtoAttr bitIndex = OpcUaUtils.getDataBitIndexForRriAttrGwid( rriAttrNode.gwid(), clsId2RriAttrInfoes );
      ...
      if( rriAttrCmdNode != null ) {
        ...
        nodes.add( rriAttrCmdNode.getNodeCmdArgInt() == null ? NodeId.NULL_VALUE : rriAttrCmdNode.getNodeCmdArgInt() );
        nodes.add( rriAttrCmdNode.getNodeCmdArgFlt() == null ? NodeId.NULL_VALUE : rriAttrCmdNode.getNodeCmdArgFlt() );
    ...
    for( UaNode2Gwid evtNode : autoEvents ) {
      ...
      String strid = String.format( CFG_EVENT_UNIT_ID_FORMAT, Long.valueOf( System.currentTimeMillis() ), gwid.strid(),
          gwid.propId() );
