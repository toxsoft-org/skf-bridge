...
public class OpcToS5DataCfgUnitM5Model
   ...
   * Model ID.
   */
  public static final String MODEL_ID_TEMPLATE = "bridge.cfg.opcua.m5.OpcToS5DataCfgUnitM5Model"; //$NON-NLS-1$
  ...
  /**
   * Attribute {@link OpcToS5DataCfgUnit#getDataNodes2() } gwids list
   */
  IM5MultiModownFieldDef<OpcToS5DataCfgUnit, IAtomicValue> NODES;
   ...
   * @param aNodesListEditorModelId String - идентификатор модели редактирования списка нодов
   */
  public OpcToS5DataCfgUnitM5Model( String aModelId, String aNodesListEditorModelId ) {
    super( aModelId, OpcToS5DataCfgUnit.class );

    NODES = new M5MultiModownFieldDef<>( FID_NODES, aNodesListEditorModelId ) {// NodesForCfgM5Model.MODEL_ID
      ...
      protected IAvList doGetFieldValue( OpcToS5DataCfgUnit aEntity ) {
        return aEntity.getDataNodes2();
      }
