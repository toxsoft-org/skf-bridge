...
import static org.toxsoft.core.tslib.av.impl.AvUtils.avInt;
import static org.toxsoft.core.tslib.av.impl.AvUtils.avStr;
import static org.toxsoft.core.tslib.av.impl.AvUtils.avValobj;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.ERR_CMD_EXECUTORS_NOT_CHANGED;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.ERR_DOJOB_NOT_CONNECTION;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.ERR_GATEWAY_ALREADY_INITED;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.ERR_HISTDATA_WRITE_CHANNEL_NOT_FOUND;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.ERR_NOT_READY_FOR_SYNC;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.ERR_REGISTER_CMD_GWIDS;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.ERR_SEND_CMD;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.ERR_SEND_CMD_STATE;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.ERR_SEND_HISTDATA;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.ERR_SYNCHONIZE;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.ERR_TRY_SYNCH_FROM_DOJOB;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_CHANGE_CMD_EXECUTORS;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_GW_ALIEN_COMMAND;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_GW_CLOSE;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_GW_CLOSED;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_GW_COMMAND_STATE_TRANSFER;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_GW_COMMAND_TRANSFER;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_GW_COMMAND_TRANSFER_FINISH;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_GW_EVENT_TRANSFER;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_GW_EVENT_TRANSFER_FINISH;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_GW_GWIDS_LIST;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_GW_HISTDATA_TRANSFER;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_GW_HISTDATA_TRANSFER_FINISH;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_GW_INIT_FINISH;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_GW_INIT_START;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_GW_PAUSED;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_GW_PAUSE_QUERY;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_GW_REMOTE_CONNECTED;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_GW_REMOTE_DISCONNECTED;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_GW_STARTED;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_GW_START_QUERY;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_REGISTER_CHANNELS_COMPLETED;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_REGISTER_DATA_ON_REMOTE;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_REGISTER_QUALITY_COMPLETED;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_SYNCHONIZE_BY_DATAQUALITY_RESOURCES;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_SYNCHONIZE_BY_DATAQUALITY_RESOURCES_FINISH;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_SYNC_COMPLETED;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_TRANSFER_EXECUTORS_FINISH;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.MSG_TRANSFER_EXECUTORS_START;
import static org.toxsoft.skf.bridge.s5.supports.IS5Resources.mSG_GW_COMMAND_STATE_TRANSFER_FINISH;
import static org.toxsoft.uskat.s5.common.IS5CommonResources.cause;
 ...
 * @author mvk
 */
class S5Gateway extends Stridable implements IS5Gateway, IS5ServerJob, //
	...
	/**
	 * Список идентификаторов команд поддерживаемых локальными исполнителями и
	 * зарегистрированные на удаленном сервере
	 */
	...
	public void doJob() {
		...
		threadExecutor.asyncExec(new Runnable() {
	...
	//
	private final class InternalCommandStateChangedListener implements IGenericChangeListener {
	...
	//
	private final class InternalGloballyHandledGwidsListener implements IGenericChangeListener {
	 ...
	 *
	 * @param aConnection           {@link ISkConnection} открываемое удаленное
	 *                              соединение
	 * @param aProvider             {@link ISkConnection} поставщик соединений с
	 *                              сервером
	 * @param aTreadExecutor        {@link ITsThreadExecutor} исполнитель потоков
	 * @param aConfiguration        {@link ISkGatewayConfiguration} конфигурация
	 *                              шлюза
	 * @param aInitialImplementaion {@link IS5InitialImplementation} начальная,
	 *                              неизменяемая конфигурация локального сервера
	 ...
	 * Синхронизация наборов данных, слушателей подключенных соединений
	 *
	 * @param aPaused boolean <b>true</b> мост приостановил работу, но возможно
	 *                установлена связь с удаленным сервером;<b>false</b> мост
	 *                работает в штатном режиме, но возможна потеря связи с
	 *                удаленным сервером
	 */
	 ...
	 *
	 * @param aCmdGwids {@link IGwidList} список идентификаторов команд
	 *                  поддерживаемые локальными исполнителями
	...
	/**
	 * Возвращает список {@link Gwid}-идентификаторов событий которые принимаются
	 * клиентами соединения
	 * <p>
	 * Все {@link Gwid} которые не являются {@link EGwidKind#GW_EVENT} молча
	 * игнорируются
	 * <p>
	...
	/**
	 * Возвращает список идентификаторов команд которые могут быть выполнены службой
	 * команд
	 *
	...
	/**
	 * Настроить порт передачи текущих данных для импорта значений с удаленного
	 * сервера
	 *
	 * @param aCurrdataBackend {@link IS5BackendCurrDataSingleton} поддержка службы
	 *                         текущих данных
	 * @param aCurrDataPort    {@link S5GatewayCurrDataPort} порт передачи текущих
	 *                         данных
	 * @param aIgnoredDataIds  {@link IGwidList} список данных которые не должны
	 *                         быть импортированы
